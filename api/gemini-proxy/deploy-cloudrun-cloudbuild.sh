#!/usr/bin/env bash
# Deploy gemini-proxy to Cloud Run using Cloud Build (no local Docker required).
# Usage: from this directory, run: bash deploy-cloudrun-cloudbuild.sh
...
echo "Building image with Cloud Build and deploying to Cloud Run..."
